    ...
    return (
        ...
        >
            <Link href="/" className="relative w-full flex justify-center items-center">
                    <span className="absolute jacquard-24-regular blur-sm opacity-50 text-4xl md:text-6xl text-[#ff0000] w-full text-center">
                        &gt; ./rolandv.sh_
                    </span>
                    ...
                    {/* Texte principal */}
                    <span className="jacquard-24-regular  text-4xl md:text-6xl text-[#ff0000] w-full text-center">
                        &gt; ./rolandv.sh_
                    </span>
            </Link>
        </div>
