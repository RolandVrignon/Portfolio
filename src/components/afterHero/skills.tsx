  ...
  return (
    <section id="skills-section">
      ...
      <div className="w-screen p-4 md:p-6 lg:p-16 flex justify-start items-end relative bg-white">
        <div className="gothic text-[#171414] text-[11.5vw] leading-[10vw]">
          Hi, I am<br /> Roland <br />Vrignon,
          a <br />passionate <br />developer<br />
          and a <br />design <br />enthusiast.
          <svg
            ...
            style={{
              ...
              verticalAlign: "middle", // Centre le SVG avec le texte
              marginBottom: "0.1em", // Ajustement fin (ajustez selon vos besoins)
            }}
          >
            <path
